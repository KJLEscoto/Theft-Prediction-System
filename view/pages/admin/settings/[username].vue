          ...
          <section class="flex justify-center w-full gap-5 px-5 flex-wrap"> 
            ...
            <div class="m-auto grid gap-2">
              ...
              <div class="flex justify-start gap-3 items-end">
                <img draggable="false" class="w-40 h-40 border-4 border-custom-400 dark:border-custom-300" :src="previewAvatar || user.avatar">
                <img draggable="false" class="w-24 h-24 border-4 border-custom-400 dark:border-custom-300" :src="previewAvatar || user.avatar">
                <img draggable="false" class="w-14 h-14 border-2 border-custom-400 dark:border-custom-300" :src="previewAvatar || user.avatar">
              </div>
            </div>
