        ...
        <UForm 
          ...
          <div class="flex justify-between items-center">
            ...
            <div class="flex justify-end w-1/2 gap-x-2">
              ...
              <section class="w-auto">
                <UButton label="Cancel" icon="i-lucide-x" @click="setPreviewAvatar(undefined)"
          ...
          <section class="flex justify-center w-full gap-5 px-5 flex-wrap"> 
            ...
            <div class="m-auto grid gap-2">
              ...
              <div class="flex justify-start gap-3 items-end">
                <img class="w-40 h-40 border-4 border-custom-400 dark:border-custom-300" :src="previewAvatar || undefined">
                <img class="w-24 h-24 border-4 border-custom-400 dark:border-custom-300" :src="previewAvatar || undefined">
                <img class="w-14 h-14 border-2 border-custom-400 dark:border-custom-300" :src="previewAvatar || undefined">
              </div>
            </div>
...
const validate = (state: any): FormError[] => {
  const errors = []
  if (!state.user.first_name) errors.push({ path: 'first_name', message: 'Required' })
  if (!state.user.last_name) errors.push({ path: 'last_name', message: 'Required' })
  if (!state.user.gender) errors.push({ path: 'gender', message: 'Required' })
  if (!state.user.phone_number) errors.push({ path: 'phone_number', message: 'Required' })
  ...
  try {
    ...
    if (response) {
      ...
      setTimeout(() => {
        ...
        load.label.value = 'Save';
        load.bool.value = false;
        navigateTo(`/admin/users/${state.user.username}`)
      }, 800)
    }
  } catch (error: any) {    
    load.label.value = 'Save';
