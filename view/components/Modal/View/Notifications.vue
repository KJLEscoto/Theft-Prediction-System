    ...
    <div class="h-auto w-full p-7 flex flex-col gap-3">
      ...
      <section class="flex justify-between items-center">
        <h1 class="text-lg font-semibold">
          Motion Detected 
          <span v-if="notification.role == 'admin' || notification.role == 'superadmin'" class="text-blue-600 dark:text-blue-500 truncate">
      ...
      <section class="flex flex-col gap-1">
        ...
        <span class="text-xs text-custom-400 font-semibold flex items-center justify-center">
